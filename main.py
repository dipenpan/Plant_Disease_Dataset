...
# ---------------------------------------------------
    ...
    <div class="hero-card">
        ...
        <p class="muted">
            Upload a plant leaf image and analyze it with the model.
            This version also shows the top 3 predictions for a more advanced feel.
        </p>
    </div>
    """, unsafe_allow_html=True)
    ...
    if uploaded_file is None:
        ...
        with result_col:
            ...
            <div class="soft-card">
                ...
                <div class="muted">
                    Click <strong>Analyze Leaf</strong> to generate prediction results,
            ...
            if analyze:
                ...
                <div class="{box_class}">
                    ...
                    <p><strong>Confidence:</strong> {top_score:.2f}%</p>
